...
local OptionScreen = Class(Screen, function( self, lord )
	...
	local serverNameStr = "Auto Chores Settings"
	...
	self.config = KnownModIndex:LoadModConfigurationOptions(modname, false)
