...
local ChoresWheel = Class(Widget, function(self)
  ...
  self.flag ={
    axe = {pinecone=false, charcoal=false, shovel=false},
    pickaxe={ nitre=false, goldnugget=true, rocks=false, ice=false, moonrocknugget=false},
  ...
  self.layout ={
    ...
    {"pickaxe", "nitre","goldnugget","rocks","ice","moonrocknugget"},
